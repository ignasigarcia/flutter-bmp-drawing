...
class DrawDirect72 extends StatefulWidget {
  final int width;
  final int height;
  final int maxPixels;

  const DrawDirect72({Key key, this.width, this.height, this.maxPixels}) : super(key: key);

  @override
  _DrawState createState() => _DrawState();
}

class _DrawState extends State<DrawDirect72> {
  Int32List pixels;
  Point lastPoint;
  int color;
  double thickness = 2;
  ...
  Future<ui.Image> makeImage() {
    ...
    //   pixels[i] = Color.fromRGBO(255, 0, 0, 1).value;
    // }
